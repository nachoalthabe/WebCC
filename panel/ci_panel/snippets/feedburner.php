...
<?php else: ?>
	...
	<fieldset class="set">
		<p class="guide"><?php _e('By adding your FeedBurner URL here, your main feed will be served by FeedBurner instead of your Wordpress site.', 'acoustic'); ?></p>
		<?php ci_panel_textarea('feedburner_feed', __('FeedBurner Feed URL', 'acoustic')); ?>
	</fieldset>
