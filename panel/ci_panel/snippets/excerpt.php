...
<?php else: ?>
	...
	<fieldset class="set">
		<p class="guide"><?php _e('You can select whether you want the Content or the Excerpt to be displayed on listing pages.', 'acoustic'); ?></p>
		<label><?php _e('Use the following on listing pages', 'acoustic'); ?></label>
		<?php ci_panel_radio('preview_content', 'use_content', 'enabled', __('Use the Content', 'acoustic')); ?>
		<?php ci_panel_radio('preview_content', 'use_excerpt', 'disabled', __('Use the Excerpt', 'acoustic')); ?>

		<p class="guide mt10"><?php _e('You can set what the Read More text will be. This applies to both the Content and the Excerpt.', 'acoustic'); ?></p>
		<?php ci_panel_input('read_more_text', __('Read More text', 'acoustic')); ?>

		<p class="guide mt10"><?php _e('You can define how long the Excerpt will be (in words). You can also set the text that appears when the excerpt is auto-generated and is automatically cut-off. These options only apply to the Excerpt.', 'acoustic'); ?></p>
		<?php ci_panel_input('excerpt_length', __('Excerpt length (in words)', 'acoustic')); ?>
		<?php ci_panel_input('excerpt_text', __('Excerpt auto cut-off text', 'acoustic')); ?>
	</fieldset>
