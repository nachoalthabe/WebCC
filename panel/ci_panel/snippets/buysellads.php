...
<?php else: ?>
	...
	<fieldset class="set">
		<p class="guide"><?php _e('Paste here your BuySellAds.com code, as given by the BSA website, and it will be automatically included on every page. Then use our BSA Widget for your sidebar code.', 'acoustic'); ?></p>
		<?php ci_panel_textarea( 'buysellads_code', __('BuySellAds.com Code', 'acoustic') ); ?>
	</fieldset>
