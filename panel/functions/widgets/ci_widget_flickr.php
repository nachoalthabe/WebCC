...
class CI_Flickr extends WP_Widget {
	...
	function CI_flickr() {
		$widget_ops = array('description' => __('FlickR Widget','acoustic'));
	...
	function form($instance) { 
		...
		?>
		<p>
			<label><?php _e('Title:','acoustic'); ?></label>
		...
		<p>
			<label><?php _e('Type:','acoustic'); ?></label>
		...
		<p>
			<label><?php _e('Number:','acoustic'); ?></label>
		...
		<p>
			<label><?php _e('Sorting:','acoustic'); ?></label>
