				...
				<div class="content-inner">	
					...
					<div id="meta-wrap" class="group">
						<ul class="single-meta">
							<?php if ($album_date != ""): ?><li><span><?php _e('Release date:','acoustic'); ?></span> <?php echo $album_date; ?></li><?php endif; ?>
							<?php if ($album_label != ""): ?><li><span><?php _e('Label:','acoustic'); ?></span> <?php echo $album_label; ?></li><?php endif; ?>
							<?php if ($album_cat_no != ""): ?><li><span><?php _e('Catalog #:','acoustic'); ?></span> <?php echo $album_cat_no; ?></li><?php endif; ?>
						</ul>
					</div><!-- /meta-wrap -->					
					<?php ci_e_content(); ?>					
				</div>
